...
const Input = (props) => {
   ...
   switch (props.type) {
      case "input":
         element = (
            <input className={inputStyles.join(" ")} {...props.config} value={props.value} onChange={props.changed} />
         );
         break;
      case "textarea":
         element = (
      ...
      case "file":
         element = (
            <div className={styles.AvatarInput}>
               <Avatar width={240} height={240} onCrop={props.changed} onClose={props.changed} src={props.value} />
               {props.value ? (
